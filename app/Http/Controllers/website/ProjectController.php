...
class ProjectController extends Controller
{
  ...
  public function success($id) //'sal_created_by',
  {
    $data = Project::with([
      'sal_created_by', 'sal_project_attach',
      'sal_skills_by.sal_skill',
    ...
    if ($data != null) {
      ...
      if (!Auth()->check()) {
        ...
        if ($data != null) {
          return view('website.users.project.success', compact('data', 'canMakeOffer'));
        } else {
          return response(['error' => true, 'error-msg' => 'Not found'], 404);
        }
      }
  ...
  public function cancel($id) //'sal_created_by',
  {
    $data = Project::with([
      'sal_created_by', 'sal_project_attach',
      'sal_skills_by.sal_skill',
    ...
    if ($data != null) {
      ...
      if (!Auth()->check()) {
        ...
        if ($data != null) {
          return view('website.users.project.error', compact('data', 'canMakeOffer'));
        } else {
          return response(['error' => true, 'error-msg' => 'Not found'], 404);
        }
      }
