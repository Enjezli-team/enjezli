...
<?php $__env->startSection("content"); ?>
    <div class="profile">
        ...
        <div class="d-flex project_container">
            ...
            <a class='title' href="<?php echo e(route('projects.show',$item['id'])); ?>"> <div class="personal_info_container myworks">
                <div class="container_card">
                    ...
                    <div class="liks_shows">
                        <a href="<?php echo e(route('projects.show',$item['id'])); ?>"><button class="show_more"> التقديم</button></a>
                    </div>
                </div>
                </div>
            </a>
