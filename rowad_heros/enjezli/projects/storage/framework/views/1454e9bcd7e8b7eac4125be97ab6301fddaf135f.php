                    ...
                    <div class="">
                        <div class="">
                            <div class="p-3  shadow-lg rounded-3">
                                <h2 class="text-center"> تعديل عمل
                                </h2>
                                ...
                                <form method="POST" action="<?php echo e(route('works.update', $data['id'])); ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="user-box mt-3">
                                        ...
                                        <input id="face" value=" <?php echo e($data->title); ?>" name="title" type="text" class="form-control">
                                    ...
                                    <div class="user-box mt-3">
                                        ...
                                        <input id="face" value=" <?php echo e($data->link); ?>" name="link" type="url" class="form-control">
                                    ...
                                    <div class="user-box mt-2">
                                        ...
                                        <textarea id="face" name="description" type="text" class="form-control" rows="6"><?php echo e($data->description); ?></textarea>
...
<?php echo $__env->make("website.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Road Project\Enjezli-new\rowad_heros\enjezli\projects\resources\views/website/users/works/edit.blade.php ENDPATH**/ ?>