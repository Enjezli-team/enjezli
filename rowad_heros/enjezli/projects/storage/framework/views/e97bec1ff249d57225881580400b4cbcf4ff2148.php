...
<div class="loginContainer_2 sign-up-container">
 ...
 <div class="login_icon_box">
                            ...
                            <div class="profile-pic">
                                ...
                                <input id="file" name="image" value="<?php echo e($data->sal_user->image); ?>" type="file" onchange="loadFile(event)" />
                                <img src="<?php echo e(asset('images/'.$data->sal_user->image)); ?>"
                                    id="output" width="200" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg row-md">
                            ...
                            <select  name="country" class="form-select form-control">
                                <option selected><?php echo e($data->country); ?></option>
            ...
            <div class="col-lg row-md">
                <div class="p-3  shadow-lg rounded-3">
                    ...
                    <div class="user-box mt-2">
                        ...
                        <textarea id="face" name="describe" type="text" class="form-control" rows="11"><?php echo e($data->description); ?></textarea>
...
<?php /**PATH D:\Road Project\Enjezli-new\rowad_heros\enjezli\projects\resources\views/website/users/profile/edit.blade.php ENDPATH**/ ?>