...
<div class="loginContainer_2 sign-up-container">
    <div class=" img-squares_2"><img src="<?php echo e(asset('auth_assets/profile_assests/svg/enLogo.svg')); ?>" alt=""></div>
    <div class=" img-squares_3"><img src="<?php echo e(asset('auth_assets/profile_assests/svg/enLogo.svg')); ?>" alt=""></div>
                    ...
                    <label class="-label" for="file">
                      ...
                      <span>
                        <svg id="edit_1_" data-name="edit (1)" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path id="Path_90" data-name="Path 90" d="M18.656.93,6.464,13.122A4.966,4.966,0,0,0,5,16.657V18a1,1,0,0,0,1,1H7.343a4.966,4.966,0,0,0,3.535-1.464L23.07,5.344a3.125,3.125,0,0,0,0-4.414,3.194,3.194,0,0,0-4.414,0Zm3,3L9.464,16.122A3.02,3.02,0,0,1,7.343,17H7v-.343a3.02,3.02,0,0,1,.878-2.121L20.07,2.344a1.148,1.148,0,0,1,1.586,0,1.123,1.123,0,0,1,0,1.586Z" fill="#fff"/>
                            <path id="Path_91" data-name="Path 91" d="M23,8.979a1,1,0,0,0-1,1V15H18a3,3,0,0,0-3,3v4H5a3,3,0,0,1-3-3V5A3,3,0,0,1,5,2h9.042a1,1,0,1,0,0-2H5A5.006,5.006,0,0,0,0,5V19a5.006,5.006,0,0,0,5,5H16.343a4.968,4.968,0,0,0,3.536-1.464l2.656-2.658A4.968,4.968,0,0,0,24,16.343V9.979A1,1,0,0,0,23,8.979ZM18.465,21.122a2.975,2.975,0,0,1-1.465.8V18a1,1,0,0,1,1-1h3.925a3.016,3.016,0,0,1-.8,1.464Z" fill="#fff"/>
                          </svg>
                          
                      </span>
                    </label>
                    <input id="file" type="file" name="image" onchange="loadFile(event)"/>
                    <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" id="output" width="200" />
                  </div>
            </div>
        </div>
                                                ...
                                                <div class="col-lg row-md">
                                                    <div class="user-box mt-2">
                                                        ...
                                                        <?php if($errors->has('phone')): ?> <small class="text-danger"><?php echo e($errors->first('phone')); ?></small> <?php endif; ?>
                                                        ...
                                                        <?php if($errors->has('birth_date')): ?> <small class="text-danger"><?php echo e($errors->first('birth_date')); ?></small> <?php endif; ?> 
                                                    ...
                                                    <div class="col-lg row-md">
                                                            ...
                                                            <div class="user-box mt-2">
                                                                ...
                                                                <?php if($errors->has('gander')): ?> <small class="text-danger"><?php echo e($errors->first('gander')); ?></small> <?php endif; ?> 
                                                        ...
                                                        <div class="col-lg row-md">
                                                                ...
                                                                <?php if($errors->has('country')): ?> <small class="text-danger"><?php echo e($errors->first('country')); ?></small> <?php endif; ?> 
                                ...
                                <div class="user-box mt-3">
                                    ...
                                    <?php if($errors->has('facebook')): ?> <small class="text-danger"><?php echo e($errors->first('facebook')); ?></small> <?php endif; ?> 
                                ...
                                <div class="user-box mt-2">
                                    ...
                                    <?php if($errors->has('tweeter')): ?> <small class="text-danger"><?php echo e($errors->first('tweeter')); ?></small> <?php endif; ?> 
                                ...
                                <div class="user-box mt-2">
                                    ...
                                    <?php if($errors->has('github')): ?> <small class="text-danger"><?php echo e($errors->first('github')); ?></small> <?php endif; ?> 
                                            ...
                                            <h2 class="text-center"> ملفي الشخصي
                                                ...
                                                <div class="row gx-5" >
                                                    ...
                                                    <label class="container-checkbox" >  <span class="check_text"> صاحب مشاريع</span>
                                                        ...
                                                        <?php if($errors->has('role')): ?> <small class="text-danger"><?php echo e($errors->first('role')); ?></small> <?php endif; ?> 
                                                ...
                                                <div class="col-lg row-md">
                                                    ...
                                                    <div class="user-box mt-2">
                                                     ...
                                                     التخصص</b> </label>
                                                        ...
                                                        <?php if($errors->has('major')): ?> <small class="text-danger"><?php echo e($errors->first('major')); ?></small> <?php endif; ?> 
                                    ...
                                    المسمى الوظيفي</b> </label>
                                        ...
                                        <?php if($errors->has('Job_title')): ?> <small class="text-danger"><?php echo e($errors->first('Job_title')); ?></small> <?php endif; ?> 
                                ...
                                <div class="user-box">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <?php if($errors->has('skills')): ?> <small class="text-danger"><?php echo e($errors->first('skills')); ?></small> <?php endif; ?> 
                                    ...
                                    <div class="user-box mt-2">
                                        ...
                                        <textarea id="face"  name="describe" type="text" class="form-control" rows="8">
                                            ...
                                            <?php if($errors->has('describe')): ?> <small class="text-danger"><?php echo e($errors->first('describe')); ?></small> <?php endif; ?> 
