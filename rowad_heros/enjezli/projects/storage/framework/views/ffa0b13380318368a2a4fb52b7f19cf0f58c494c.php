...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('auth_assets/work_assests/css/header.css')); ?>">
    <style>
        /*************/
            ...
            <div class="personal_info_container myworks">
                ...
                <div class="container_card">
                    ...
                    <div class="liks_shows">
                        ...
                        <button class="show_more"><a href="/works/<?php echo e($item->id); ?>/edit"
                            class="edit_pro button button-1">تعديل</a></button>
                            <form class="card-body" action="/works/<?php echo e($item->id); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\Road Project\Enjezli-new\rowad_heros\enjezli\projects\resources\views/website/users/works/index.blade.php ENDPATH**/ ?>