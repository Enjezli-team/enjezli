    ...
    <div class="login-box sign-up">
        ...
        <form method="POST" action="<?php echo e(route('register.custom')); ?>">
            ...
            <div class="user-box">
                ...
                <?php if($errors->has('name')): ?> <small class="text-danger"><?php echo e($errors->first('name')); ?></small> <?php endif; ?> 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="user-box">
                ...
                <?php if($errors->has('password_confirmation')): ?> <small class="text-danger"><?php echo e($errors->first('password_confirmation')); ?></small> <?php endif; ?> 
...
</div><?php /**PATH C:\Users\DELL\Desktop\n\Enjezli-new\rowad_heros\enjezli\projects\resources\views/auth/register.blade.php ENDPATH**/ ?>