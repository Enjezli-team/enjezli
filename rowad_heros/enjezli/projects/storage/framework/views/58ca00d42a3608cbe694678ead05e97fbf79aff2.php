                                ...
                                <?php if(!$data->sal_project_attach->isEmpty()): ?>
                                    <h4> ملفات توضيحية</h4>
                                        <?php $__empty_1 = true; $__currentLoopData = $data->sal_project_attach; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attach): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <li>
                                                    <a href='http://localhost:8000/public/images/<?php echo e($attach->file_name); ?>' style='color:black'><?php echo e($attach->file_name); ?></a>
                                            </li>  
                                ...
                                <?php $__currentLoopData = $data->sal_offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="accordion-body">
                                        ...
                                        <div class="personal_info_container myworks">
                                            ...
                                            <div class="select">
                                                <a href="<?php echo e(route('offers.edit',$offer->id)); ?>" style="color:black"> تعديل</a>
                                            ...
                                            <?php elseif(Auth::user()->id==$data['user_id']&& $offer->status==1 && $data->status==1): ?>
                                                <form action="<?php echo e(route('acceptOffer')); ?>" method="post">
                                                    <?php echo csrf_field(); ?>
                                                    <input style="display:none" type="text" name="offer_status" value='<?php echo e($offer->status); ?>'>
                                            ...
                                            <?php elseif(Auth::user()->id==$data['user_id']&&$offer->status==2 && $data->status==1 ): ?>
                                            <form action="<?php echo e(route('cancelConfirm')); ?>" method="post">
                                                <?php echo csrf_field(); ?>
                                                <input style="display:none" type="text" name="offer_status" value='<?php echo e($offer->status); ?>'>
                                                <input style="display:none" type="text" name="offer_id" value='<?php echo e($offer->id); ?>'>
                                                <input style="display:none" type="text" name="project_owner" value='<?php echo e($data['user_id']); ?>'>
                                                <input style="display:none" type="text" name="project_status" value='<?php echo e($data['status']); ?>'>
                                            ...
                                            <?php elseif(Auth::user()->id==$data['user_id']&&$offer->status==5&&$data->status==3||Auth::user()->id==$data->handled_by): ?>
                                        ...
                                        السعر  <span class="desc"> <?php echo e($offer->price); ?></span> 
...
<?php echo $__env->make("website.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Road Project\Enjezli-new\rowad_heros\enjezli\projects\resources\views/website/users/project/show.blade.php ENDPATH**/ ?>