...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
    <div class="container mx-auto px-6 py-8">
                ...
                <div class="w-full  mt-6 px-6 sm:w-1/2 xl:w-1/5 sm:mt-0">
                    <div class="flex justify-center py-1 shadow-sm rounded-md bg-[#219EBC]">
                        ...
                        <div class="mx-5 text-left">
                            <a class="text-white" href="{{ route('create_skills') }}">اضافة مهاره  </a>
                        </div>
        ...
        <div class="flex flex-col mt-8 items-end">
            <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8  w-1/2">
                <div
                        ...
                        @foreach ($skills as $skills)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="text-sm leading-5 text-gray-900">{{$skills->title}}</div>
                                </td>
                                ...
                                <td
                                    ...
                                    <form action="{{ route('delete_skills',$skills->id) }}" method="POST">
                                        <div class="flex  ">
                                        <a class="mx-2" href="{{route('edit_skills',$skills->id)}}">
                                        ...
                                        <?php if($skills->status == '1'){ ?> 
                                            ...
                                            <a href="{{url('/admin/status-update_skills',$skills->id)}}" class="mx-2">
