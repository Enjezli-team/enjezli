                                                ...
                                                <div class="container_card">
                                                    <header class="">
                                                        ...
                                                        <div>
                                                            ...
                                                            <h4> {{ $offer->sal_provider_by->sal_profile->Job_title}} </h4>
                                                        </div>
                                                        <div>
                                                            <div class="evaluated">
                    ...
                    <div>
                        ...
                        <div class="d-grid">
                            <label class="d-flex align-items-baseline gap-2">
                             <input type="radio" class="option-input radio" name="example" @if ($data->status==1)
                             checked
                             @else
                                disabled
                             @endif  />
