...
<div class="loginContainer_2 sign-up-container">
    <div class=" img-squares_2"><img src="{{ asset('auth_assets/profile_assests/svg/enLogo.svg')}}" alt=""></div>
    <div class=" img-squares_3"><img src="{{ asset('auth_assets/profile_assests/svg/enLogo.svg')}}" alt=""></div>
