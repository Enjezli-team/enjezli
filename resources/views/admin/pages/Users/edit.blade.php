			...
			<div class="w-full rounded bg-gray-100 p-4">	
				...
				<div class="">
					<div class="flex flex-col md:flex-row md:items-center md:justify-between">
						<div class="flex-1">
							<div x-show="step === 1">
								<div class="text-lg font-bold text-right text-gray-700 leading-tight">تعديل مستخدم</div>
							</div>
				...
				<div class="">	
					<div>
                        ...
                        @method('PATCH')
							...
							<input name="image" id="fileInput" accept="image/*" value="{{$data->image}}" class="hidden" type="file" @change="let file = document.getElementById('fileInput').files[0]; 
