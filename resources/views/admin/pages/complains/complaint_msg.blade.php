...
<div class="flex flex-col   w-full bg-white px-4 py-6">
    <div class="flex flex-row items-center py-4 px-6 ">
        ...
        <div class="grid grid-cols-12 gap-y-2">
          <div class="col-start-1 col-end-8 p-3 rounded-lg">
            <div class="flex flex-row items-center">
              <div
                  class="flex items-center justify-center h-10 w-10 rounded-full bg-blue-200 flex-shrink-0"
              >
                س
              </div>
              <div
              ...
              >
                <div>السلام عليكم لدى شكوى ضد الاخ ...</div>
              </div>
            </div>
          </div>
          <div class="col-start-1 col-end-8 p-3 rounded-lg">
            <div class="flex flex-row items-center">
              ...
              >
                <div>
              الاخ فلان فلان لم يقم بواجبة على اكمل وجه
                </div>
              </div>
            </div>
          </div>
          <div class="col-start-6 col-end-13 p-3 rounded-lg">
            <div class="flex items-center justify-start flex-row-reverse">
              <div
                  class="flex items-center justify-center h-10 w-10 rounded-full bg-[#8ECAE6] flex-shrink-0"
              >
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25" height="25" class="my-4" viewBox="0 0 219.503 305.654">
                <defs>
              ...
              >
                <div>حسنا سوف نتحقق من الامر </div>
              </div>
            </div>
          </div>
          <div class="col-start-6 col-end-13 p-3 rounded-lg">
          ...
          <div class="col-start-1 col-end-8 p-3 rounded-lg">
            <div class="flex flex-row items-center">
              ...
              <div
                  class="relative ml-3 text-sm bg-white py-2 px-4 shadow rounded-xl"
              >
                <div>لقد تم التواصل معي من قبل المنجز وتم حل المشكلة</div>
              </div>
            </div>
          </div>
          <div class="col-start-6 col-end-13 p-3 rounded-lg">
            <div class="flex items-center justify-start flex-row-reverse">
              ...
              >
                <div>
                    يعتذر انجزلي لما بدر من المنجز من تقصير باداء عملة 
                </div>
                <div
