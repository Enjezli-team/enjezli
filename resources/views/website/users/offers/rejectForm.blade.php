                        ...
                        <div class="">
                            <div class="">
                                <div class="p-3  shadow-lg rounded-3">
                                    <h2 class="text-center"> رفض استلام المشروع
                                    </h2>
                                    <div class="logo-container">

                                    </div>

                                    <form method="POST" action="{{ route('rejectDelivery') }}"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="user-box mt-2 d-grid gap-3">
                                            <input type="text" style='display:none' name='offer_id'
                                                value="{{ $offer_id }}">

                                            <label> سبب الرفض </label>
                                            <textarea id="face" name="seeker_reason" type="text" class="form-control" rows="6"></textarea>
