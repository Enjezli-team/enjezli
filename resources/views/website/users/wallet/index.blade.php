                    ...
                    <div class="card-body position-relative z-index-1 ">
                        ...
                        <div class="col-4 tcard">
                            ...
                            <div class="me-auto w-20 d-flex align-items-center gap-3 justify-content-end">
                                <img class=" mt-2" src="{{ asset('master.svg') }}" alt="logo" style="width: 100%">>
                                <img class="mt-2" src="{{ asset('svg/visa.svg') }}" alt="logo" style="width: 100%">
                                <img class=" mt-2" src="{{ asset('svg/paypal-seeklogo.com.svg') }}" alt="logo" style="width: 100%">
                            </div>
                        </div>
                    </div>
                </div>
