    ...
    <div class="col-md-12 mt-4">
      <div class="card">
        ...
        <div class="card-body pt-4 p-3">
          <form method="POST" action="{{ route('works.update', $data['id']) }}" enctype="multipart/form-data">
            ...
            <div class="login_icon_box">
              <div class="profile-pic">
                ...
                <input id="text" name="imageold" value="{{$data->file}}" type="text" hidden>
                <img src={{asset('images/'.$data->file)}} id="output" width="200">
              </div>
            </div>
            ...
            <div class="row">
              <div class="mb-3 col-sm-12 col-md-6 col-lg-6">
                ...
                <input value="{{$data->title}}" name="title" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              ...
              <div class="mb-3 col-sm-12 col-md-6 col-lg-6">
                ...
                <input value="{{$data->link}}" name="link" type="url" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              ...
              <div class="mb-3 col-sm-12 ">
                ...
                <textarea id="face" name="description" type="text" class="form-control" rows="5">value="{{$data->description}}"</textarea>
