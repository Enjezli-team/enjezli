...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    return /******/ (() => {
        ...
        (() => {
            ...
            function TooltipUI_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    TooltipUI_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
                    TooltipUI_defineProperties(Constructor, staticProps);
                return Constructor;
            }
                ...
                DropdownUI_createClass(DropdownUI, [
                    ...
                    },
                    {
                        ...
                        value: function show() {
                            ...
                            var windowWidth =
                                external_jQuery_default()(window).width();
            ...
            external_jQuery_default()(document).on("click", function (e) {
                if (
                    !external_jQuery_default()(e.target).closest(
                        ".note-btn-group"
                    ).length
                ) {
                    external_jQuery_default()(
