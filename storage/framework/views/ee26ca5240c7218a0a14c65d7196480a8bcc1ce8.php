                    ...
                    <form method="POST" action="<?php echo e(route('profiles.update', $data['id'])); ?>" enctype="multipart/form-data">
                        ...
                        <div class="login_icon_box">
                            <div class="profile-pic">
                                ...
                                <input id="" name="imageold" value="" type="text" value="<?php echo e($data->sal_user->image); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
                                ...
                                <select name="country" class="form-select form-control">
                                    <option <?php echo e(($data->country=='اليمن') ? 'selected' : ''); ?> value="1">اليمن</option>
                                    <option <?php echo e(($data->country=='السعوديه') ? 'selected' : ''); ?> value="السعوديه">انثى</option>
                                </select>
                            ...
                            <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
                                ...
                                <input value="<?php echo e($data->Facebook); ?>" name="Facebook" type="فثءف" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
...
<?php echo $__env->make('website.layouts.master_dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\لااله ال الله\مجلد جديد\Enjezli-new\resources\views/website/users/profile/edit.blade.php ENDPATH**/ ?>