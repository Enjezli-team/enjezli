...
padding: 10px 10px;">
   <h6>تفاصيل مشروع :<?php echo e($data['title']); ?> </h6>
    </div>
            ...
            <div>
                ...
                <div class="d-grid">
                    <label class="d-flex align-items-baseline gap-2">
                        <input type="radio" class="option-input radio" name="example" <?php if($data->status == 1): ?> checked
                        <?php else: ?>
                        disabled <?php endif; ?> />
                        مرحلة تلقي العروض </label>
                    <label class="d-flex align-items-baseline gap-2">
                        <input type="radio" class="option-input radio" name="example" <?php if($data->status == 2): ?> checked
                        <?php else: ?>
                        disabled <?php endif; ?> />
                        مرحلة التنفيذ</label>
                    <label class="d-flex align-items-baseline gap-2"> <input type="radio" class="option-input radio" name="example" <?php if($data->status == 3): ?> checked
                        <?php else: ?>
...
<?php echo $__env->make("website.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\لااله ال الله\مجلد جديد\Enjezli-new\resources\views/website/users/project/project_details_th.blade.php ENDPATH**/ ?>