        ...
        <div class="col-md-12 mt-4">
            <div class="card">
                ...
                <div class="card-body pt-4 p-3">
                    <form method="POST" action="<?php echo e(route('works.update', $data['id'])); ?>" enctype="multipart/form-data">
                        ...
                        <div class="login_icon_box">
                            <div class="profile-pic">
                                ...
                                <input id="text" name="imageold" value="<?php echo e($data->file); ?>" type="text" hidden>
                                <img src=<?php echo e(asset('images/'.$data->file)); ?> id="output" width="200">
                            </div>
                        </div>
                        <div class="card-header pb-0 px-3">
                            <h6 class="mb-0 text-primary"> تعديل عمل</h6>
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input value="<?php echo e($data->title); ?>" name="title" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            ...
                            <div class="mb-3 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input value="<?php echo e($data->link); ?>"  name="link" type="url" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            ...
                            <div class="mb-3 col-sm-12 ">
                                ...
                                <textarea id="face" name="description" type="text" class="form-control" rows="5">value="<?php echo e($data->description); ?>"</textarea>
...
<?php echo $__env->make('website.layouts.master_dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\laaaaaaaaaaaaaaaaaaast\Enjezli-new\resources\views/website/users/works/edit.blade.php ENDPATH**/ ?>