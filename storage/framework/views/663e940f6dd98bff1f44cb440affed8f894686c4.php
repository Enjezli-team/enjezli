                                ...
                                <?php if(!$data->sal_project_attach->isEmpty()): ?>
                                    <h4> ملفات توضيحية</h4>
                                        <?php $__empty_1 = true; $__currentLoopData = $data->sal_project_attach; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attach): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <li>
                                                    <a href='<?php echo e($attach->file_name); ?>' style='color:black'><?php echo e($loop->iteration); ?>.<?php echo e($attach->file_type); ?></a>
                                            </li>
                                ...
                                <?php $__currentLoopData = $data->sal_offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="accordion-body" id='offer<?php echo e($offer->id); ?>'>
                                        ...
                                        <div class="personal_info_container myworks">
                                            ...
                                            <div class="select">
                                                <a href="<?php echo e(route('offers.edit',$offer->id)); ?>" style="color:black ;text-decoration:none" class="note"> تعديل</a>
                                            ...
                                            <form action="<?php echo e(route('cancelConfirm')); ?>" method="post">
                                                ...
                                                <input style="display:none" type="text" name="offer_id" value='<?php echo e($offer->id); ?>'>
                                                <input style="display:none" type="text" name="project_owner" value='<?php echo e($data['user_id']); ?>'>
                                                <input style="display:none" type="text" name="project_id" value='<?php echo e($data['id']); ?>'>
                                            ...
                                            <?php elseif(Auth::user()->id==$data['user_id']&&$offer->status==3&&$data->status==2||Auth::user()->id==$data->handled_by): ?>
                                            ...
                                            <?php elseif(Auth::user()->id==$data['user_id']&&$offer->status==3&&$data->status==3 ||Auth::user()->id==$data->handled_by): ?>
                                            
                                            <form action="<?php echo e(route('confirmDelivery')); ?>" method="post">
                                                <?php echo csrf_field(); ?>
                                                <input style="display:none" type="text" name="offer_id" value='<?php echo e($offer->id); ?>'>
                                                <input style="display:none" type="text" name="project_owner" value='<?php echo e($data['user_id']); ?>'>
                                                <input style="display:none" type="text" name="project_id" value='<?php echo e($data['id']); ?>'>
                                            ...
                                            <?php elseif(Auth::user()->id==$data['user_id']&&$offer->status==3&&$data->status==5 ||Auth::user()->id==$data->handled_by): ?>
                                          ...
                                          <ul class="list-unstyled mb-0 list-unstyled job_det attachment_contianer">
                                            <?php if(!$offer->sal_offer_attach->isEmpty()): ?>
                                                <h4> ملفات توضيحية</h4>
                                                    <?php $__empty_1 = true; $__currentLoopData = $offer->sal_offer_attach; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer_attach): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                        <li>
                                                                <a href='<?php echo e($offer_attach->file_name); ?>' style='color:black'><?php echo e($loop->iteration); ?>.<?php echo e($offer_attach->file_type); ?></a>
                                                        </li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            ...
                                            <?php else: ?>
                                            <div class="desc"> <?php echo e(Str::substr($offer->description,0, 80)); ?>...</div>
                                          <?php endif; ?>
                                      </div>
                                        </div>
            ...
            <div class="col-lg-4 ">
                ...
                <div class="personal_info_container myworks">
                    ...
                    <div class="d-flex align-items-flex-start">
                        <div class="img_con">
                            <img src="
                            <?php if($data->sal_created_by->image!=null): ?>
                            <?php echo e($data->sal_created_by->image); ?>
...
<?php echo $__env->make("website.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\لااله ال الله\مجلد جديد\Enjezli-new\resources\views/website/users/project/show.blade.php ENDPATH**/ ?>