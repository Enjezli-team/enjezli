                ...
                <div class="w-full  mt-6 px-6 sm:w-1/2 xl:w-1/5 sm:mt-0">
                    <div class="flex justify-center py-1 shadow-sm rounded-md bg-[#219EBC]">
                        ...
                        <div class="mx-5 text-left">
                            <a class="text-white" href="<?php echo e(route('create_section')); ?>">اضافة قسم  </a>
                        </div>
                        ...
                        <?php $__currentLoopData = $section; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 ">
                                    <div class="text-base leading-5 text-gray-900"><?php echo e($section->title); ?></div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 ">
                                    ...
                                    <div class="text-base leading-5 text-gray-900"><?php echo e($section->id); ?></div>
                                ...
                                <td
                                    ...
                                    <form action="<?php echo e(route('delete_section',$section->id)); ?>" method="POST">
                                      <div class="flex  ">
                                        <a class="mx-2" href="<?php echo e(route('edit_section',$section->id)); ?>">
                                        ...
                                        <?php if($section->status == '1'){ ?> 
                                            ...
                                            <a href="<?php echo e(url('/admin/status-update_section',$section->id)); ?>" class="mx-2">
...
<?php echo $__env->make('Admin.layout.side', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\enjezli\enjezli\resources\views/Admin/section.blade.php ENDPATH**/ ?>