...
تعرض هذه الصفحة العروض التي قدمت اليها
  ...
  <?php if(!$offers->isEmpty()): ?>
    ...
    padding: 1px 12px;" class="status">مرفوض</a>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a style='background-color:transparent'
                                                    href="<?php echo e(route('cancelOffer', $offer->id)); ?>"> <button type="button"
                            ...
                            <?php elseif($offer->sal_project_id->status == 6 && $offer->status == 3): ?>
                                <a href="<?php echo e(route('ComplainForm', $offer->id)); ?>">
                                ...
                                <div class='personal_info_first'>
                                    <div class='phone'>
                                        <i class='bx bx-time'></i> <span class='time'> 22/2/2 22:22pm
                                            <?php echo e($offer->sal_project_id->sal_created_by->name); ?>
                            ...
                            <div class='personal_desc'>
                                ...
                                <div class='details'>
                                    ...
                                    <div>
                                        ...
                                        <?php elseif($offer->sal_project_id->status == 7 && $offer->status == 3): ?>
...
<?php echo $__env->make('website.layouts.master_dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\Road\v3\Enjezli-new\resources\views/website/users/offers/index.blade.php ENDPATH**/ ?>