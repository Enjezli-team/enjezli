                ...
                <div class="card-header pb-0 p-3">
                    <div class="row">
                        ...
                        <div class="col-md-4 text-start ">
                            <a href="/profiles/<?php echo e($data->sal_profile->id); ?>/edit">
                ...
                <div class="card-body p-3 p card_custom">
                    <ul class="list-group ">
                        ...
                        <li class="list-group-item border-0 d-flex  justify-content-between align-items-center mb-1">
                            ...
                            <form action="/profiles/<?php echo e($skill->id); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                            ...
                            <div class="card card-blog card-plain ">
                                <form action="/works/<?php echo e($work->id); ?>" method="POST">
                                    ...
                                    <div class="col-md-4 text-start d-flex justify-content-end align-items-baseline " style="width: 100%">
                                        <a class="btn btn-link pe-3 ps-0 mb-0  " href="/works/<?php echo e($work->id); ?>">
                                            <i class="fa fa-eye  text_primary"></i>
                                        </a>
                                        <a class="btn btn-link pe-3 ps-0 mb-0  " href="/works/<?php echo e($work->id); ?>/edit">
...
<?php echo $__env->make('website.layouts.master_dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\لااله ال الله\مجلد جديد\Enjezli-new\resources\views/website/users/profile/show.blade.php ENDPATH**/ ?>